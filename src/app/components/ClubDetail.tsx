...
import { ChevronLeft, Copy, Check, Key } from "lucide-react";
...
export function ClubDetail() {
  ...
  // Guardamos o ID no localStorage para sabermos o último clube visitado
  useEffect(() => {
    if (id) localStorage.setItem("lastClubId", id);
  }, [id]);

  const inviteUrl = `go.entradasegura.com.br/clube/${id}/exemplo123`;
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans animate-in fade-in duration-300">
      ...
      <div className="p-6 max-w-md mx-auto w-full flex-1 flex flex-col justify-center items-center">
        ...
        <p className="text-center text-[15px] text-gray-500 mb-8 px-4 leading-relaxed">
          O convidado utilizará este link para realizar o cadastro e liberar o acesso ao clube.
        </p>
