...
export const MOCK_AUTHORIZATIONS = [
  {
    ...
    destino: "Campo de Golfe",
    autorizador: "João Silva (Titular)", // Vínculo com o sócio
    periodo: "Hoje até 6 Meses",
    status: "No local",
    entrada: "Hoje, 07:15",
  },
  {
    ...
    type: "Visitante",
    destino: "English Bar",
    autorizador: "Ana Costa (Dependente)",
    periodo: "Hoje até 1 Semana",
    status: "No local",
    entrada: "Hoje, 10:30",
  },
  // Mesma pessoa pode ter mais de uma autorização vigente ao mesmo tempo
  // (ex.: convidada por dois sócios diferentes, pra espaços diferentes).
  {
    id: "2b",
    name: "Maria Souza",
    avatar: "https://i.pravatar.cc/150?u=maria",
    ...
    autorizador: "Roberto Almeida (Titular)",
    periodo: "Hoje até 2 Semanas",
  ...
  },
  {
    ...
    cpf: "333.444.555-66",
    type: "Prestador de Serviço",
    destino: "Manutenção / Jardinagem",
    autorizador: "Administração do Clube",
    periodo: "Hoje até 6 Meses",
    status: "No local",
    entrada: "Hoje, 06:00",
  },
