    ...
    <motion.div initial={{ x: 50, opacity: 0 }} animate={{ x: 0, opacity: 1 }} className="flex-1 flex flex-col h-full bg-white">
      ...
      <div className="flex-1 p-6 bg-gray-50">
        ...
        <input
          ...
          inputMode="numeric"
          className="w-full bg-white border-2 border-gray-200 px-5 py-4 rounded-xl text-[18px] font-semibold focus:outline-none focus:border-gray-900 text-gray-900"
        />
